...
clicker.click(function () {
  ...
  // Apply color to page
  page.css("background-color", randomColor.hex);
  clicker.css("background-color", randomColor.hex);

  // Contrast
  if (
    randomColor.families.includes("white") ||
    randomColor.families.includes("light") ||
    randomColor.families.includes("yellow") ||
    randomColor.families.includes("tan") ||
    randomColor.families.includes("peach") ||
    randomColor.families.includes("pale")
  ) {
    page.css("color", "black");
    clicker.css("color", "black");
    container.css("border-color", "black");
    clicker.css("border-color", "black");
  } else {
    page.css("color", "white");
    clicker.css("color", "white");
    container.css("border-color", "white");
    clicker.css("border-color", "white");
  }

  // Change color value
  name.text(randomColor.name);
  hex.text(randomColor.hex);
  rgb.text(randomColor.rgb);

  // Change color family tag
  family.text(randomColor.families);
});
